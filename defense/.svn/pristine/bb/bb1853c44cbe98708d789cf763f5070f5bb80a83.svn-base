!function (a, b, c, d) {
    ...
    var u = "bootstrapDualListbox", v = {
        ...
        filterTextClear: "展开所有",
        filterPlaceHolder: "查询",
        moveSelectedLabel: "添加选择",
        moveAllLabel: "添加所有",
        removeSelectedLabel: "删除选择",
        removeAllLabel: "删除所有",
        moveOnSelect: !0,
        ...
        selectedFilter: "",
        infoText: "记录显示 {0}",
        infoTextFiltered: '<span class="label label-warning">搜索到</span> {0} 从 {1}',
        infoTextEmpty: "空内容",
        filterOnValues: !1,
        buttonClass: "btn-white btn-bold"
